...
- `dist/release/tahoe-linux-amd64-YYYYMMDD-HHMMSS.iso`
- `dist/release/tahoe-linux-amd64-YYYYMMDD-HHMMSS.iso.sha256`
...
5. **Verify checksum (recommended)**
   ```bash
   sha256sum -c tahoe-linux-amd64-YYYYMMDD-HHMMSS.iso.sha256
   ```
